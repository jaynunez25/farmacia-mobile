...
export interface Product {
  ...
  sale_price_box?: string;
  sale_price_blister?: string;
  ...
  /** API computed: shelf_location or location. */
  shelf_display?: string | null;
  is_verified: boolean;
  ...
  /** Flag for auditor workflow (distinct from needs_review). */
